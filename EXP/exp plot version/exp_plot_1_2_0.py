...
class superplt():
    def write_superplt(relation, Directory, textTitle, Time=None):
        ...
        if relation.slope is not None:
            TEXT.append("slope : " + str(relation.slope))
            TEXT.append("intercept : " + str(relation.intercept))
    ...
    def plot(relation, fitlegend = None, fitxnum = 1001, 
    ...
    def plot_comp(relation, fitlegend = None, fitxnum = 1001, Title = None, 
        ...
        # 백업 파일 기본 디렉토리
        BaseDirectory = '/content/drive/MyDrive/Coding/EXP/plots/'
        ...
        timelist = Shvar.change_time_to_text()
        time_for_Title = timelist[0] + '_' + timelist[1]
        Title = 'plot_' + time_for_Title
        textTitle = 'plotinfo_' + time_for_Title
        plt.savefig(BaseDirectory + Title + '.png')
