...
import sys
sys.path.append('/content/drive/My Drive/Coding/EXP/')
from retrievename import retrieve_name
...
# 2_3_0 버젼
    ...
    # 이는 __init__을 이용해 이루어질 것이고, retrievename.py를 이용해 이루어진다.
...
class Shvar():
    ...
    def __init__(self):
        ...
        self.slope = None
        self.R2 = None
        self.varname = retrieve_name(self)
