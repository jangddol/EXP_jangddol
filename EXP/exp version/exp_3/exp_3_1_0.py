...
class Shvar(RememberInstanceCreationInfo):
    ...
    def readshvartext(Date='today', Time='now', imp=False):
        ...
        if Date == 'today': # 오늘일 경우의 디렉토리이름
            ...
            yesterday = datetime.date.today(pytz.timezone('Asia/Seoul')) - timedelta(days=1)
