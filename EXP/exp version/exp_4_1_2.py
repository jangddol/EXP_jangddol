...
class Shvar(RememberInstanceCreationInfo):
    ...
    def linear_rel(self, X, Y, fit=True):
        ...
        if (X.tp == 'uflist' or X.tp == 'ufdatalist') and (Y.tp == 'uflist' or Y.tp == 'ufdatalist'):
            ...
            if fit:
                temp = linfit.linfit.linear_fitting_York(X.uf, Y.uf, initguess='yerr')
            ...
            if fit:
                temp = linfit.linfit.linear_fitting_Yerr(X.scalarlist, Y.mean, Y.SE)
            ...
            if fit:
                temp = linfit.linfit.linear_fitting_Yerr(Y.scalarlist, X.mean, X.SE)
